...
const Index = () => {
  return (
    <div className="min-h-screen flex flex-col bg-amb-light text-amb-dark">
      {/* Header */}
      ...
      <main className="flex-grow container mx-auto px-4 py-8 space-y-12">
        ...
        <section className="text-center py-16 bg-white rounded-lg shadow-lg">
          <h2 className="text-4xl md:text-5xl font-extrabold text-amb-primary mb-6 leading-tight">
            Dignified, Independent Living at Home
          </h2>
          <p className="text-lg md:text-xl text-amb-dark max-w-3xl mx-auto mb-8">
          ...
          <Button className="bg-amb-primary hover:bg-amb-dark text-amb-light px-8 py-3 text-lg rounded-full shadow-md transition-colors duration-300">
            Learn More
          </Button>
        </section>
        ...
        <section className="py-12">
          <Card className="bg-amb-accent text-amb-dark shadow-lg border-none">
            <CardHeader>
              <CardTitle className="text-3xl md:text-4xl font-bold text-center text-amb-dark">
        ...
        <section className="py-12 text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-amb-primary mb-6">
            Contact Us
          </h2>
          <div className="bg-white p-8 rounded-lg shadow-lg max-w-2xl mx-auto">
            <p className="text-lg text-amb-dark">
        ...
        {/* Disclaimer Section */}
        <section className="py-12 bg-white rounded-lg shadow-lg p-8">
          <h2 className="text-2xl font-bold text-amb-dark mb-4">Disclaimer</h2>
